    ...
    <main>
        ...
        <div class= "index" id="page1">
            ...
            <div class="qna">
                ...
                <div class="answer">
                    <form action="">
                        <input type="radio" name="1" id=""/>1. 13인치 ~ 14인치</br>
                        <input type="radio" name="1" id=""/>2. 15인치 ~ 16인치</br>
            ...
            <div class="qna">
                ...
                <div class="answer">
                    <form action="">
                        ...
                        <input type="radio" name="1" id=""/>1. MacOS 🍎</br>
                        <input type="radio" name="1" id=""/>2. Windows 🖼</br>
                        <input type="radio" name="1" id=""/>3. Linux 🐧</br>
                        <input type="radio" name="1" id=""/>4. FreeDos </br>
                    </form>
                </div>
...
<div class= "index" id="page3">
    ...
    <div class="qna">
        ...
        <div class="answer">
            <form action="">
                <input type="radio" name="1" id=""/>1. PhotoShop (이미지작업)</br>
                <input type="radio" name="1" id=""/>2. Programming (프로그래밍)</br>
                <input type="radio" name="1" id=""/>3. Premiere Pro (영상작업)</br>
                <input type="radio" name="1" id=""/>4. Battleground (게임)</br>
                <input type="radio" name="1" id=""/>5. WebSurfing (영상작업)</br>
            </form>
        </div>
...
<div class= "index" id="page4">
    ...
    <div class="qna">
        ...
        <div class="answer">
            <form action="">
                <input type="radio" name="1" id=""/>1. 전문가</br>
                <input type="radio" name="1" id=""/>2. 학생 혹은 취미</br>
                <input type="radio" name="1" id=""/>3. 잘모르겠어요.</br>
            </form>
        </div>
...
<div class= "index" id="page5">
    ...
    <div class="qna">
        ...
        <button class="downToBtn" type="submit"  onclick="submit()">결과보기</button>
    </div>
